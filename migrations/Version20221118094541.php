 ...
 */
final class Version20221118094541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test1 (id INT AUTO_INCREMENT NOT NULL, test1 VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test2 (id INT AUTO_INCREMENT NOT NULL, test1_id INT NOT NULL, INDEX IDX_13BB8D58C4C599C7 (test1_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE test2 ADD CONSTRAINT FK_13BB8D58C4C599C7 FOREIGN KEY (test1_id) REFERENCES test1 (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test2 DROP FOREIGN KEY FK_13BB8D58C4C599C7');
